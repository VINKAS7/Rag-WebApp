        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
            <div className="bg-[#2C2C2E] rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
                ...
                <div className="mt-6">
                    <button
                        type="button"
                        className="w-full inline-flex justify-center cursor-pointer px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-green-700 focus:outline-none focus:ring-0"
                        onClick={handleClose}
                    >
                        OK
                    </button>
